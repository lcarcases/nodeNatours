...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGNhcmNhc2VzIiwiYSI6ImNrYmR2aTM0YjA4ZWUyc251OTdpeGszbGsifQ.QahFFYTruvcxwkhFRgd0gg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/lcarcases/ckbdw68w60ob51hmna6fsvcup',
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51GzSdvJvUmlagAgPA3mSf1d6K8rBoUD6ZUsUHrMUk8nl8Bh2ulZxh0dq4WoGpQvA9inyO6lRG1SL0IgRoH3i0CYR00l5p361Ac');
            _context.prev = 1;
            _context.next = 4;
...
if (loginForm) //console.log("entro");
